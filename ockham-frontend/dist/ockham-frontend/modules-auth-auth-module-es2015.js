...
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"custom-padding\" fxFlexFill>\n  <div class=\"container\">\n    <router-outlet></router-outlet>\n  </div>\n</div>");
...
/* harmony import */ var _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./reset-password/reset-password.component */ "./src/app/modules/auth/reset-password/reset-password.component.ts");
...
AuthComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./auth.component.scss */ "./src/app/modules/auth/auth.component.scss")).default]
    }),
...
/* harmony import */ var _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./forgot-password/forgot-password.component */ "./src/app/modules/auth/forgot-password/forgot-password.component.ts");
/* harmony import */ var _reset_password_reset_password_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./reset-password/reset-password.component */ "./src/app/modules/auth/reset-password/reset-password.component.ts");
...
let ForgotPasswordComponent = class ForgotPasswordComponent {
    constructor(authService, notifierService) {
...
ForgotPasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_core_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"], angular_notifier__WEBPACK_IMPORTED_MODULE_4__["NotifierService"]])
...
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_core_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
...
/* harmony import */ var src_app_core_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/services/authentication.service */ "./src/app/core/services/authentication.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var src_app_shared_validators_same_passwords_validator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/validators/same-passwords.validator */ "./src/app/shared/validators/same-passwords.validator.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let ResetPasswordComponent = class ResetPasswordComponent {
    constructor(authService, notifierService, route, router) {
        this.authService = authService;
        this.notifierService = notifierService;
        this.route = route;
        this.router = router;
        this.passwordForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
            ...
            repeat_new_password: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required)
        }, { validators: src_app_shared_validators_same_passwords_validator__WEBPACK_IMPORTED_MODULE_4__["samePasswords"] });
        this.submitted = false;
    }
    ngOnInit() {
        this.route.queryParamMap.subscribe(params => {
    ...
    onSubmit() {
        ...
        this.authService.resetPassword(this.token, new_password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])())
            .subscribe(() => {
